    ...
    <el-form ref="form" :model="form" :rules="rules">
      <div class="container">
        <div class="row">
          ...
          <el-form-item label="申请单位：" class="col-size-6" prop="departmentId">
            <!-- <input type="text" placeholder="请输入申请单位" /> -->
            <el-select v-model="form.departmentId">
              <el-option v-for="option in form.meetingRoomList" :key="option.id" :label="option.name" :value="option.id">
              </el-option>
            </el-select>
          </el-form-item>
          <el-form-item  label="使用日期：" class="col-size-6 select-frame" v-if="flag == 'add'" prop="date">
            <!-- <label>使用日期：</label> -->
          ...
          <el-form-item  label="使用日期：" class="col-size-6 select-frame" v-else prop="date">
            <el-input type="text" placeholder="请输入使用日期" v-model="form.date" />
          </el-form-item>
          
          <el-form-item label="预定人：" class="col-size-6" prop="name">
            <el-input type="text" placeholder="请输入预订人姓名" v-model="form.name" />
          </el-form-item>
          <el-form-item label="联系方式：" class="col-size-6" prop="phone"> 
            <el-input type="text" placeholder="请输入预订人联系方式" v-model="form.phone" />
          </el-form-item>
          <el-form-item label="联系人：" class="col-size-6" prop="contact">
            <el-input type="text" placeholder="请输入联系人姓名" v-model="form.contact" />
          </el-form-item>
          <el-form-item label="联系方式：" class="col-size-6" prop="contactPhone">
            <el-input type="text" placeholder="请输入联系人联系方式" v-model="form.contactPhone" />
          </el-form-item>
          <el-form-item label="出席领导：" class="col-size-6" prop="attendLeaders">
            <el-input type="text" placeholder="请输入出席领导姓名" v-model="form.attendLeaders"/>
          </el-form-item>
          <el-form-item label="出席人数：" class="col-size-6" prop="attendUsers">
            <el-input type="text" placeholder="请输入出席人数" v-model="form.attendUsers"/>
          </el-form-item>
          <el-form-item label="申请事由：" class="col-size-12" prop="subject">
            <el-input type="text" placeholder="请输入申请事由" v-model="form.subject"/>
          </el-form-item>
          <el-form-item label="添加附件：" class="col-size-6" style="position:relative" >
            <el-input type="text" placeholder="请选择添加的附件" class="file" v-model="form.filename" readonly/>
            <input type="file" placeholder="请选择添加的附件" class="file-item" ref="clearFile" @change="getFile($event)"/>
          </el-form-item>
          <el-form-item class="col-size-6" style="color: #555555;text-align:left">
            附件格式（zip压缩文件、Word文档）
          </el-form-item>
